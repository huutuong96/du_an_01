            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                  <div class="item"> <a href="#"><img alt="New Special Collection" src="{{asset("/")}}public/images/banner/Anh-sale-don-gian-nhung-dep.jpg" height="315px"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      {{-- <h2 class="cat-heading">New Fashion</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p> --}}
                    </div>
                  </div>
                  <div class="item"> <a href="#"><img alt="New Fashion" src="{{asset("/")}}public/images/banner/bannershop.jpg" height="315px"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      {{-- <h2 class="cat-heading">New Fashion</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p> --}}
                    </div>
                  ...
                  <ul class="products-grid">
                    ...
                    <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        <div class="item-inner">
                          <div class="item-img">
                              <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="{{route("product_detail", ["id"=> $item->id])}}"> <img alt="" src="{{asset("public/images/product/".$item->list_image[0]->image)}}"> </a>
