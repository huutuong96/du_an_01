              ...
              <div class="product-img-box col-lg-4 col-sm-5 col-xs-12" style="height: 20%">
                <div class="product-image" style="height: 400px;">
                  <div class="product-full">
                    ...
                    <img id="product-zoom" style="height: 400px;" src="{{ isset($product->list_img[0]->image) ? url('public/images/product/' . $product->list_img[0]->image) : url('public/images/default.jpg') }}" data-zoom-image="{{ isset($product->list_img[0]->image) ? url('public/images/product/' . $product->list_img[0]->image) : url('public/images/default.jpg') }}" alt="product-image"/> </div>
                    {{-- <img id="product-zoom" style="height: 400px;" src="{{ isset($item->list_img[0]->image) ? url('public/images/product/' . $item->list_img[0]->image) : url('public/images/default.jpg') }}" data-zoom-image="{{asset("public/images/product/".$product->list_img[0]->image)}}" alt="product-image"/> </div> --}}
                    ...
                    <div class="item-img">
                        <div class="item-img-info">
                            <a class="product-image" title="Product tilte is here" href="{{route("product_detail", ["id"=> $item->id])}}">
                              <img alt="Product tilte is here" src="{{ isset($item->list_img[0]->image) ? url('public/images/product/' . $item->list_img[0]->image) : url('public/images/default.jpg') }}"> 
                            </a>
