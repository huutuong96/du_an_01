                                                            ...
                                                            @if($cart!=null  && isset($cart["products"]))
                                                                ...
                                                                <ul class="mini-products-list" id="cart-sidebar" style="">
                                                                    @foreach ($cart["products"] as $item)
                                                                        <li class="item">
                                                                            <div class="item-inner"><a class="product-image" title="Product tilte is here" href="product-detail.html"><img alt="Product tilte is here" src="{{asset("images/product/".$item->list_image[0]->image)}}"></a>
